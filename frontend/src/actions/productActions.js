...
import {
  PRODUCT_LIST_FAIL, PRODUCT_LIST_SUCCESS, PRODUCT_LIST_REQUEST, PRODUCT_DETAILS_REQUEST, PRODUCT_DETAILS_SUCCESS, PRODUCT_DETAILS_FAIL, PRODUCT_DELETE_REQUEST, PRODUCT_DELETE_SUCCESS, PRODUCT_DELETE_FAIL, PRODUCT_CREATE_FAIL,
...
export const listBanner = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get('/api/bannerUpload/getBanner')
    console.log(data)
    dispatch({
...
export const updateBanner = (banner) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`/api/bannerUpload/updateBanner`, banner, config
    )
